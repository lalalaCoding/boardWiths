...
<div class="container lg" style="height: 3300px; width: 86%;">
	<h2>서비스 약관 / 정책</h2><br>
	<h3>제 1 조 (목적)</h3>
	본 약관은 서비스 이용자가 보드라이프 boardlife(이하 "회사"라 합니다)이 제공하는 온라인상의 인터넷 서비스(이하 "서비스"라고 하며, 접속 가능한 유무선 단말기의 종류와는 상관없이 이용 가능한 "회사"가 제공하는 모든 "서비스"를 의미합니다. 이하 같습니다)에 회원으로 가입하고 이를 이용함에 있어 회사와 회원(본 약관에 동의하고 회원등록을 완료한 서비스 이용자를 말합니다. 이하 "회원"이라고 합니다)의 권리,의무 및 책임사항을 규정함을 목적으로 합니다.
	...
	1 회원등록은 제3조에 정한 절차에 의한 서비스 이용자의 회원가입 신청과 회사의 회원등록 승낙에 의하여 성립합니다. 회사는 회원가입 신청자가 필수사항 등을 성실히 입력하여 가입신청을 완료하였을 때에는 필요한 사항을 확인한 후 지체 없이 이를 승낙을 하여야 합니다. 단 회원가입 신청서 제출 이외에 별도의 자료 제출이 요구되는 경우에는 예외로 합니다.
	2 회사는 아래 각 호에 해당하는 경우에는 회원등록의 승낙을 유보할 수 있습니다.
	...
	3 회사는 아래 각 호에 해당하는 경우에는 회원등록을 거절할 수 있습니다.
	가입신청서의 내용을 허위로 기재하였거나 허위서류를 첨부하여 가입신청을 하는 경우
	이미 존재하는 회원이 생성한 또 다른 계정임이 확인된 경우
	...
	1 회원은 서비스 이용을 위한 회원 ID, 비밀번호의 관리에 대한 책임, 본인 ID의 제3자에 의한 부정사용 등 회원의 과실로 인해 발생하는 모든 불이익에 대한 책임을 부담합니다. 단, 이것이 회사의 과실로 인하여 야기된 경우는 회사가 책임을 부담합니다.
	...
	회원은 아래 각 호에 해당하는 사항이 변경되었을 경우 즉시 회원정보 관리페이지에서 이를 변경하여야 합니다. 이 경우 회사는 회원이 회원정보를 변경하지 아니하여 발생한 손해에 대하여 책임을 부담하지 아니하며, 법인 회원의 경우에는 회사가 별도로 정하는 방법으로 변경할 수 있습니다.
	생년월일, 거주지역 및 연락처 등
	...
	<h3>제 8 조 (서비스 이용)</h3>
	<p>
	1 서비스 이용은 회사의 서비스 사용승낙 직후부터 가능합니다. 다만, 유료 서비스의 경우 회사가 요금납입을 확인한 직후부터 가능하게 할 수 있습니다.
	2 커뮤니티의 안정성 및 사이트 훼손의 우려가 발생할 시 회사는 즉각 이를 수정하기 위해 서비스 사용승낙이 완료된 회원으로부터 추가 정보를 수집할 수 있습니다.
	3 민법상 미성년자인 회원이 유료 서비스를 이용할 경우 미성년자인 회원은 결제 전 법정대리인의 동의를 얻어야 합니다.
	4 서비스 이용시간은 회사의 업무상 또는 기술상 불가능한 경우를 제외하고는 연중무휴 1일 24시간(00:00-24:00)으로 함을 원칙으로 합니다. 다만, 서비스설비의 정기점검 등의 사유로 회사가 서비스를 특정범위로 분할하여 별도로 날짜와 시간을 정할 수 있습니다.
	</p>
	<h3>제 9 조 (서비스내용변경 통지 등)</h3>
	<p>
	1 회사가 서비스 제공을 위해 계약한 CP(Contents Provider)와의 계약종료, CP의 변경, 신규서비스의 개시 등의 사유로 서비스 내용이 변경되거나 서비스가 종료되는 경우 회사는 회원의 등록된 전자우편 주소로 이메일을 통하여 서비스 내용의 변경 사항 또는 종료를 통지할 수 있습니다.
	...
	4 커뮤니티의 안정성 및 사이트가 훼손된다고 판단되는 경우 회사는 통지없이 회원에게 인증 절차 요구 및 필요한 회원 정보를 추가로 요구하여 사이트를 안전하게 유지할 수 있습니다.
	5 위의 4항으로 수집된 개인 정보는 사이트를 안전하게 유지하기 위한 용도(제 11조 서비스 이용의 제한 및 중지)로만 사용되며, 그 외의 용도로는 사용하지 않습니다.
	</p>
	<h3>제 10 조 (권리의 귀속 및 저작물의 이용)</h3>
	1 회원이 서비스 내에 게시한 게시물 등(이하 "게시물 등"이라 합니다)의 저작권은 해당 게시물의 저작자에게 귀속됩니다.
	2 타인의 개인 정보가 포함된 게시물에 대한 책임은 해당 게시물의 저작자에게 있으며, 내용에 대한 저작권 및 법적 책임은 또한 게시물의 저작자에게 있으며 보드라이프의 입장과 다를 수 있습니다.
	3 게시물 등은 검색결과 내지 서비스 및 관련 프로모션 등에 노출될 수 있으며, 해당 노출을 위해 필요한 범위 내에서는 일부 수정, 복제, 편집되어 게시될 수 있습니다. 이 경우, 회사는 저작권법 규정을 준수하며, 회원은 언제든지 고객센터 또는 각 서비스 내 관리기능을 통해 해당 게시물 등에 대해 삭제, 검색결과 제외, 비공개 등의 조치를 취할 수 있습니다.
	4 회사는 제3항 이외의 방법으로 회원의 게시물 등을 이용하고자 하는 경우에는 피드, 쪽지, 문자, 전화, 전자우편 등을 통해 사전에 회원의 동의를 얻습니다.
	<h3>제 11 조 (서비스 이용의 제한 및 중지)</h3>
	1 회사는 아래 각 호에 해당하는 사유가 발생한 경우에는 회원의 서비스 이용을 제한하거나 중지시킬 수 있습니다.
	회원이 회사 서비스의 운영을 고의로 방해하는 경우
	회원 의무를(제13조) 위반한 경우
	...
	3 제17조 제2항에 의해 회사가 회원과의 계약을 해지하고 탈퇴시키기로 결정한 경우 회사는 회원의 탈퇴 처리 전에 이를 통지하여야 합니다. 단, 커뮤니티 규칙의 절차에 따라 사유와 제한 기간 등을 사전에 고지받은 회원과 불법 도박, 마약, 성인 광고 등을 게시판 회원은 즉각 제한 중지 및 탈퇴가 가능합니다.
	4 회원이 서비스를 이용하는 도중, 연속하여 삼(3)개월 동안 서비스를 이용하기 위해 log-in한 기록이 없는 경우, 회사는 당해 회원 "한메일넷 서비스"의 전자우편 수신을 제한할 수 있습니다.
	...
	<h3>제 12 조 (회사의 의무)</h3>
	1 회사는 회사의 서비스 제공 및 보안과 관련된 설비를 지속적이고 안정적인 서비스 제공에 적합하도록 유지, 점검 또는 복구 등의 조치를 성실히 이행하도록 노력합니다.
	2 회사는 회원이 수신 동의를 하지 않은 영리 목적의 광고성 전자우편, SMS 문자메시지, 알림톡 등을 발송하지 아니합니다.
	...
	<h3>제 13 조 (회원의 의무)</h3>
	1 회원은 아래 각 호에 해당하는 행위를 하여서는 아니 됩니다.
	게시글, 코멘트, 쪽지 등을 통해 반말, 욕설, 비난, 비아냥을 글을 작성하는 행위
	미성년에게 유해한 활동의 게시글, 코멘트, 쪽지, 정보 등을 작성하는 행위 (성인물, 성적농, 성적 닉네임, 성적 프로필 사진, 성인 광고 등)
	개인 정보가 노출된 글이나 코멘트를 작성하는 행위( 실명, 전화번호, 주민번호, 계좌번호 등 )
	특정 회원, 집단 및 제3자에 대한 저격성 글이나 코멘트를 작성하는 행위
	욕설,폭언,협밥,원색적 비난, 비아냥, 비속어와 그의 파생어, 인신공격성 단어의 사용이나 발언 글을 작성하는 행위
	회원에게 지속적인 게시글, 코멘트, 쪽지 등을 작성하여 그 내용을 강요하거나 커뮤니티 활동을 방해하는 행위
	보상을 대가로 링크가 포함된 홍보 글을 작성하는 행위
	타 사이트의 콘텐츠를 무단 발췌하여 게시글을 작성하는 행위
	회원이 회사 서비스의 운영을 고의로 방해하는 행위
	...
	2 회사는 회원이 제1항의 행위를 하는 경우 해당 게시물 등을 삭제 또는 임시 삭제할 수 있고 서비스의 이용을 제한하거나 일방적으로 본 계약을 해지할 수 있습니다.
