...
<body>
    ...
    <div class="container" style="display:flex; width: 1440px;">
        ...
        <div id="content" class="d-block p-3 text-bg-light" style="width: 1100px">
            ...
            <div id="content2">
                <form action="insertMatching.bo" method="POST" enctype="multipart/form-data" id="boardForm">
                       ...
                       <!--  </div> -->
                        <div class="item">
                            ...
                            <div class="input-group input-group-sm mb-3">
								...
								<input name="pAddress" type="text" class="form-control" id="pAddress">
							</div>
			
			
                        </div>
                        <div class="item">
                            일정 :&nbsp; <input type="date" id="date" name="date"/>
                        </div>
                    </div>
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" id="title" name="title">
                    </div>              
                    <br>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">매칭글 작성</label>
                        <textarea class="form-control" rows="3" id="addText" name="content"></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <input class="btn btn-primary" type="submit" id="matchingSubmit" value="매칭등록">
                </form> 
            </div>  
            <hr>
            <div id="content3">
